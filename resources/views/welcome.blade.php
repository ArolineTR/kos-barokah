...
<section id="hero" class="d-flex align-items-center">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-10 order-lg-5 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="/img/hero-img.jpg" width="350px" height="300px" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row content">
          ...
          <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
            <p>
              ...
              yang sangat mumpuni, yaitu:
              <ul>
                <li><i class="ri-check-double-line"></i>Parkiran yang luas</li>
                <li><i class="ri-check-double-line"></i>Wifi Gratis</li>
                <li><i class="ri-check-double-line"></i>Jalan tembus ke Unwahas</li>
                <li><i class="ri-check-double-line"></i>Kamar mandi dalam</li>
                <li><i class="ri-check-double-line"></i>Dapur (Kulkas, Wastafel, Kompor)</li>
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
            ...
            <div class="content">
              <h3>Pertanyaan yang <strong>sering ditanyakan?</strong></h3>
            </div>

            <div class="accordion-list">
              <ul>
                <li>
                  <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span> Berapa jarak Kos Barokah dengan kampus Unwahas?  <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                ...
                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span> Apakah Kos Barokah merupakan kos campuran? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                ...
                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed"><span>03</span> Apakah Kos Barokah isinya orang yang Barokah? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
        ...
        <div class="row">
          <div class="col" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Tersedia Laundry Abil bisa jemput antar seharga Rp 4.000,00/kg sudah termasuk cuci gosok.</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row ">
          <div class="col" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              <h3>Non-AC</h3>
              <h4><sup>Rp</sup>500.000,00<span>per bulan</span></h4>
              <ul>
                <li><i class="bx bx-check"></i> Kasur</li>
                <li><i class="bx bx-check"></i> Lemari</li>
          ...
          <div class="col" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              <h3>AC</h3>
              <h4><sup>Rp</sup>900.000,00<span>per bulan</span></h4>
              <ul>
                <li><i class="bx bx-check"></i> AC</li>
                <li><i class="bx bx-check"></i> Kasur</li>
                <li><i class="bx bx-check"></i> Lemari</li>
                <li><i class="bx bx-check"></i> Meja Belajar</li>
                <li><i class="bx bx-check"></i> Ember, Gayung, Penyimpanan Sabun</li>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Kontak</h2>
          {{-- <p>Berikut detail dari Kos Barokah.</p> --}}
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Lokasi:</h4>
                <p><a href="https://goo.gl/maps/HxdYxDCdbt5S9Qm78">Kos Barokah, Pongangan, Kec. Gn. Pati, Kota Semarang, Jawa Tengah</a></p>
              </div>
